...
>
> This tutorial [example code](https://github.com/talo/rush-py/tree/main/examples/exess-spe){target="_blank"} uses **STO-3G**, a minimal basis set chosen purely for speed so examples
