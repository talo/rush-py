...
EXESS is developed by QDX and made available through Rush, QDX's computational platform. You can access a restricted version of EXESS (limited to small systems and lower-accuracy basis sets) through Rush. To [request full access](https://exess.qdx.co/requests), [submit a feature request](https://exess.qdx.co/requests?tab=feature), or ask questions, contact us at hello@qdx.co.
