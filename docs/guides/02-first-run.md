...
And you're done! The EXESS module has a rich set of capabilities and configuration, but by default will perform an energy calculation on the input topology molecule. To learn more about EXESS capabilities, see the [EXESS documentation](../exess/). To learn about QDX Topology files, check the [topologies section](../exess/topologies.md).
