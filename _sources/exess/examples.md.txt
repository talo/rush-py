...
These examples progress from minimal inputs to production-style workflows. They use the EXESS JSON input format, which is documented in `docs/exess/input.md`, and reference keywords defined in `docs/exess/keywords.md`.
